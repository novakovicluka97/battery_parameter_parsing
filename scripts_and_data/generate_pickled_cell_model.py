...
data_origin = 'Typhoon_cell_model'  # 'Typhoon Hil software and hardware obtained data'
# data_origin = 'P14_Boulder_cell_model'  # 'Boulder Colorado P14 battery cell data'
...
# Initialize data
if data_origin == 'P14_Boulder_cell_model':  # test data from the Boulder university
...
elif data_origin == 'Typhoon_cell_model':  # Normal data format
...
if data_origin == 'P14_Boulder_cell_model':
