...
capture_duration = 40e4/SIMULATION_SPEED_UP  # default for HIL (30*60*60) seconds, for VHIL full no hyst and no RC 23e4
...
M0Param = [0.00313, 0.00235, 0.00115]
MParam = [0.03993, 0.02002, 0.02054]
...
vhil_device = True                                    # if True, VHIL device will be used (testing of the model)
...
# Other default parameters (from the Boulder Colorado data and octave script):
...
R0Param = [4.62e-3, 1.78e-3, 1.135e-3]
...
if __name__ == "__main__":
    import battery_cell_functions as cell_functions  # importing here to avoid circular imports
    ...
    mat_data = dict()  # creating an output dictionary for all the dynamic and static data
    ...
    for temp in test_temperatures:
        for script_type in ['static', 'dynamic']:
            ...
            Script_3 = cell_functions.Script(time_vec[script_2_stop:script_3_stop],
                                             temperature[script_2_stop:script_3_stop],
            ...
            if script_type == 'static':  # add new Script object to output data dict.
                ...
                Script_4 = cell_functions.Script(time_vec[script_3_stop:script_4_stop],
                                                 temperature[script_3_stop:script_4_stop],
                                                 voltage[script_3_stop:script_4_stop],
                                                 current[script_3_stop:script_4_stop],
